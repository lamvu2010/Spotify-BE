...
<body>
    <div class="container-fluid p-0" style="background-color: #1C263C;">
                ...
                <!-- Dashboard -->
                    ...
                    <div class="col-12 bg-white pt-4 px-5">
			...
			<form:form modelAttribute="user" action="/SpotifyWeb/audience/info.htm" method="POST">
										<div hidden="true">
										...
										<div >
											...
											<c:if test="${btnStatus=='btnEdit'}">
													<a href="http://localhost:8080/SpotifyWeb/audience/info.htm" style="color: #656565; text-decoration: none;">Refresh</a>
					                                <button name="btnEdit" class="btn-spotify ms-4">Edit profile</button>
												
											</c:if>
											<c:if test="${btnStatus=='btnSave'}">
												<div class="d-flex justify-content-end align-items-center">
					                                <a href="http://localhost:8080/SpotifyWeb/audience/info.htm" style="color: #656565; text-decoration: none;">Cancel</a>
